 ...
 * ```
 */
export declare interface AttachedMedia {
    url: string;
}
 ...
 * ```
 */
export declare interface ConversationCallbacks {
 ...
 * ```
 */
export declare type ConversationOptions = ConversationWithId | ConversationWithUserBot;

export declare type ConversationType = {
    /**
     * ID of the bot associated with this conversation
     */
    bot_id: string;
 ...
 * ```
 */
export declare interface ConversationWithId {
 ...
 * ```
 */
export declare interface ConversationWithUserBot {
    user_id: string;
    bot_id: string;
    pollingInterval?: number;
}

export declare type CreateBotRequest = {
    /**
     * Name of the bot
     */
    name: string;
...
export declare type CreateBotResponse = {
    bot: Bot;
};
 ...
 */
export declare interface CreateConversationOptions {
    bot_id: string;
    user_id: string;
...
export declare type CreateConversationResponse = {
    conversation: ConversationType;
};

declare type DeleteBotData = {
    body?: never;
    path: {
        /**
         * Bot identifier
...
export declare type GetBotResponse = {
    bot: Bot;
};
 ...
 */
export declare interface GetConversationOptions {
    id: string;
}
...
export declare type GetMemoriesResponse = {
    /**
...
export declare type ListBotsResponse = {
    /**
     * List of all bots
     */
    bots: Array<Bot>;
...
declare type ListConversationsData = {
    body?: never;
    path?: never;
    query?: {
        /**
 ...
 */
export declare interface ListConversationsOptions extends NonNullable<ListConversationsData['query']> {
}

export declare type ListConversationsResponse = {
    /**
...
export declare type MemoryResponse = {
    /**
...
export declare class PrioriChat {
    private client;
    private apiToken;
...
export declare type SearchedMessage = {
    /**
...
export declare type UpdateBotRequest = {
    /**
     * New name of the bot
     */
    name: string;
...
export declare type UpdateBotResponse = {
    bot: Bot;
};
