...
export type ListContentQuery = {
  /**
   * ID of the bot to list content for (either bot_id or user_id must be provided)
   */
  bot_id?: string | null;
  /**
  ...
  search?: string | null;
  /**
   * ID of the user to list content for (either bot_id or user_id must be provided)
   */
  user_id?: string | null;
};
...
export type ListContentResponse = {
  /**
   * List of private content items (vault for conversations)
   */
  private_content: Array<Content>;
  /**
   * List of public content items (displayed on profile)
   */
  public_content: Array<Content>;
};
...
export type UploadContentRequest = {
  /**
   * ID of the bot this content belongs to (either bot_id or user_id must be provided)
   */
  bot_id?: string | null;
  /**
  ...
  image_url: string;
  /**
   * Whether this content is public (displayed on profile) or private (bot's vault for conversations). Only valid for bot content; user content is always public.
   */
  public?: boolean;
  /**
   * ID of the user this content belongs to (either bot_id or user_id must be provided)
   */
  user_id?: string | null;
};
...
export type ListContentData = {
  ...
  query?: {
    /**
     * Bot identifier (either bot_id or user_id must be provided)
     */
    bot_id?: string | null;
    /**
     * User identifier (either bot_id or user_id must be provided)
     */
    user_id?: string | null;
    /**
...
export type ListContentErrors = {
  /**
   * Invalid query parameters - either bot_id or user_id must be provided, not both
   */
  400: unknown;
  /**
   * Bot or user not found
   */
  404: unknown;
  /**
   * Internal server error
...
export type UploadContentErrors = {
  /**
   * Invalid request - URL is not an image, bot/user not found, or both/neither bot_id and user_id provided
   */
  400: unknown;
  /**
   * Internal server error
...
export type UpdateConversationResponse2 =
...
export type GenerateResponseSyncResponse2 =
  GenerateResponseSyncResponses[keyof GenerateResponseSyncResponses];
...
export type SendMessageOrCreateConversationResponse =
  SendMessageOrCreateConversationResponses[keyof SendMessageOrCreateConversationResponses];
