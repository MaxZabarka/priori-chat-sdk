...
export const zCreateConversationRequest = z.object({
    ...
    create_user_if_not_exists: z.union([
        z.boolean(),
        z.null()
    ]).optional(),
    freeform: z.union([
...
export const zConversationHeader = z.object({
    bot_id: z.string().uuid(),
    id: z.string(),
    last_message: z.union([
        zMessage,
        z.null()
    ]).optional(),
    message_count: z.number().int().gte(0),
    searched_message: z.union([
        zSearchedMessage,
        z.null()
    ]).optional(),
    user_id: z.union([
...
export const zMediaTypeFilter = z.enum([
    'image',
    'video'
]);
...
export const zListConversationsData = z.object({
    ...
    query: z.object({
        ...
        conversation_id: z.union([
            z.string(),
            z.null()
        ]).optional(),
        min_messages: z.union([
            z.number().int(),
            z.null()
        ]).optional(),
        max_messages: z.union([
            z.number().int(),
            z.null()
        ]).optional(),
        ...
        min_last_message_date: z.union([
            z.number().int(),
            z.null()
        ]).optional(),
        max_last_message_date: z.union([
            z.number().int(),
            z.null()
        ]).optional()
    }).optional()
