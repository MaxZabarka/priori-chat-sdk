...
import type {
  ...
  GenerateResponseSyncData,
  GenerateResponseSyncResponses,
  GenerateResponseSyncErrors,
  GetMemoriesData,
  ...
  SendMessageErrors,
  SendMessageOrCreateConversationData,
  SendMessageOrCreateConversationResponses,
  SendMessageOrCreateConversationErrors,
  ListUsersData,
  ListUsersResponses,
  ListUsersErrors,
  CreateUserData,
...
export const generateResponseSync = <ThrowOnError extends boolean = true>(
  options: Options<GenerateResponseSyncData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    GenerateResponseSyncResponses,
    GenerateResponseSyncErrors,
 ...
 */
export const sendMessageOrCreateConversation = <
  ThrowOnError extends boolean = true,
>(
  options: Options<SendMessageOrCreateConversationData, ThrowOnError>,
) => {
  return (options.client ?? _heyApiClient).post<
    SendMessageOrCreateConversationResponses,
    SendMessageOrCreateConversationErrors,
